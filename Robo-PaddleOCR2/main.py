...
from core.ocr_engine import extract_text_from_pdf, get_paddle_ocr
...
def startup_event():
    """
    Pre-warm and initialize PaddleOCR models on server startup.
    This eliminates the 5-8s cold start overhead on the first API extraction request.
    """
    logger.info("Initializing and pre-warming PaddleOCR engine on startup...")
    get_paddle_ocr()
